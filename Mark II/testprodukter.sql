...
INSERT INTO `products` (`id`, `name`, `description`, `articlenr`, `category_id`, `tax_id`, `created_at`, `updated_at`) VALUES
(2, 'Dumle Klubba', 'Dumle Klubbor, klubban du inte kan vara utan!', '006.004.01', 6, 4, '2013-05-07 17:05:43', '2013-05-07 17:05:43'),
(3, 'Dunderklubba (Snusklubba)', 'Denna klubben är mkt bättre än snus!', '006.004.02', 6, 4, '2013-05-07 17:10:48', '2013-05-07 17:10:48'),
...
--
-- Dumpning av Data i tabell `mediatypes`
--

INSERT INTO `mediatypes` (`id`, `name`, `created_at`, `updated_at`) VALUES
(1, 'image', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
--
...
--
-- Dumpning av Data i tabell `pricetypes`
--

INSERT INTO `pricetypes` (`id`, `name`, `created_at`, `updated_at`) VALUES
(1, 'Inköpspris (exkl. moms)', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(2, 'Pris (exkl. moms)', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
(3, '55', 3, '2013-05-07 17:10:49', '2013-05-07 17:10:49'),
