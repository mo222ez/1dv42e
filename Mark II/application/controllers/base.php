...
class Base_Controller extends Controller {
	...
	public function __construct()
	{
		...
		Asset::container('admin')->add('jQuery', 'js/jquery.js');
		Asset::container('admin')->add('tinyMCE', 'js/tinymce/tinymce.min.js');
		Asset::container('admin')->add('confirmDelete', 'js/confirmDelete.js');
		...
		Asset::container('shop')->add('checkout', 'css/shop/checkout.css');
		Asset::container('shop')->add('jQuery', 'js/jquery.js');
		Asset::container('shop')->add('slideShow', 'js/scriptSlideShow.js');
		Asset::container('shop')->add('infoButtons', 'js/infoButtons.js');
